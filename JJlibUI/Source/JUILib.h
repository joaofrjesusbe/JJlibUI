...
//  JUILib
//
//  Created by Joao Jesus on 01/11/13.
//  Copyright (c) 2013 JJCode. All rights reserved.
//
 ...
 *      - Added option to allow the tabbar when scrolling to center on items only if possible.
 *
